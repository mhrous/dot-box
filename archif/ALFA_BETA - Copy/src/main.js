...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Primitives_functionNoSuchMethod_closure: {
      "^": "Closure:11;_box_0,namedArgumentList,$arguments",
    ...
    _Completer: {
      ...
      }, "completeError$1", "call$2", "call$1", "get$completeError", 4, 2, 5, 2, 0, 1],
      $isCompleter: 1
    },
    _SyncCompleter: {
      ...
      }, "complete$0", "call$1", "call$0", "get$complete", 1, 2, 18],
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 4, 2, 5, 2, 0, 1],
      $isFuture: 1,
      static: {
    ...
    _Html5NodeValidator: {
      ...
      static: {
        ...
        _Html5NodeValidator__standardAttributeValidator: [function(element, attributeName, value, context) {
          ...
          return true;
        }, "call$4", "html__Html5NodeValidator__standardAttributeValidator$closure", 16, 0, 10, 4, 5, 6, 7],
        _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          H.interceptedTypeCheck(element, "$isElement");
          H.stringTypeCheck(attributeName);
          H.stringTypeCheck(value);
          return H.interceptedTypeCheck(context, "$is_Html5NodeValidator").uriPolicy.allowsUri$1(value);
        }, "call$4", "html__Html5NodeValidator__uriAttributeValidator$closure", 16, 0, 10, 4, 5, 6, 7]
      }
    },
    ImmutableListMixin: {
      "^": "Object;$ti",
    ...
    }, "call$1", "js___convertToJS$closure", 4, 0, 2, 8],
    ...
    }, "call$1", "js___convertToDart$closure", 4, 0, 31, 8],
    ...
    Border: {
      ...
      draw$0: function() {
        ...
        t1.width = "400px";
        for (str = "", i = 0; i <= 5; ++i)
          for (t1 = i * 80, j = 0; j <= 5; ++j)
            str += '        <div\n          class="dot"\n          style="\n              top:' + C.JSInt_methods.toInt$0(t1) + "px;\n              left:" + C.JSInt_methods.toInt$0(j * 80) + "px;\n              width:" + C.JSInt_methods.toInt$0(25) + "px ;\n              height:" + C.JSInt_methods.toInt$0(25) + 'px">\n        </div>\n         ';
        for (i = 0; i < 5; ++i)
          for (t1 = i * 5, t2 = i * 80 + 25, j = 0; j < 5; ++j)
            str += '        <div\n          class="box "\n          style="\n            top:' + C.JSInt_methods.toInt$0(t2) + "px;\n            left:" + C.JSInt_methods.toInt$0(j * 80 + 25) + "px;\n            width:" + C.JSInt_methods.toInt$0(55) + "px ;\n            height:" + C.JSInt_methods.toInt$0(55) + 'px ;"\n          data-id="' + (t1 + j) + '">\n        </div>\n        ';
        for (i = 0; i <= 5; ++i)
          for (t1 = i * 80 - 20, j = 0; j < 5; ++j)
            str += '        <div\n          class ="line-parent open"\n          style="\n            top:' + C.JSInt_methods.toInt$0(t1) + "px;\n            left:" + C.JSInt_methods.toInt$0(j * 80 + 25) + "px;\n            width:" + C.JSInt_methods.toInt$0(55) + "px ;\n            height:" + C.JSInt_methods.toInt$0(65) + "px ;\n            padding:" + C.JSDouble_methods.toInt$0(26.25) + 'px 0"\n          data-id="' + G.getId(i, j, "x") + '"\n        >\n           <div class="line" data-id="' + G.getId(i, j, "x") + '" style="height:' + C.JSDouble_methods.toInt$0(12.5) + 'px;"></div>\n        </div>\n        ';
        for (i = 0; i < 5; ++i)
          for (t1 = i * 80 + 25, j = 0; j <= 5; ++j)
            str += '        <div\n          class ="line-parent open"\n          style="\n            top:' + C.JSInt_methods.toInt$0(t1) + "px;\n            left:" + C.JSInt_methods.toInt$0(j * 80 - 20) + "px;\n            height:" + C.JSInt_methods.toInt$0(55) + "px ;\n            width:" + C.JSInt_methods.toInt$0(65) + "px ;\n            padding:0 " + C.JSDouble_methods.toInt$0(26.25) + 'px "\n          data-id="' + G.getId(i, j, "y") + '"\n        >\n           <div class="line "   data-id="' + G.getId(i, j, "y") + '" style=" height:100% ;"></div>\n        </div>\n\n\n        ';
        return str;
      },
      init$0: function() {
        var i, t1, j, id;
    ...
    Game: {
      ...
      generateComputerDecision$0: function() {
        var $async$goto = 0, $async$completer = P._makeAsyncAwaitCompleter(-1), $async$returnValue, $async$self = this, res, t1, t2, ai_move, t3;
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 3:
                ...
                t1 = $async$self.border;
                t1.toString;
                H.printString("" + 5548987495);
                t2 = t1.box;
                if ((t2 && C.JSArray_methods).indexOf$1(t2, 1) === -1) {
                  t1 = t1.box;
                  t1 = (t1 && C.JSArray_methods).indexOf$1(t1, 0) !== -1;
                } else
                  t1 = true;
                if (t1) {
                  $.DEPTH = 2;
                  H.printString("5555555");
                } else
                  G.set_DEPTH($async$self.border.move.length);
                H.printString("" + $.DEPTH);
              ...
              case 5:
                ...
                t1 = 'div[data-id="' + H.S(ai_move[0]) + '"]';
                t2 = document;
                J.get$classes$x(t2.querySelector(t1)).remove$1(0, "open");
                t2 = J.get$classes$x(t2.querySelector('div[data-id="' + H.S(ai_move[0]) + '"]'));
                t1 = $.$get$ROUND();
                t3 = $async$self.round;
                if (t3 >= 2) {
                  $async$returnValue = H.ioore(t1, t3);
                  // goto return
                  $async$goto = 1;
                  break;
                }
                ...
                H.printString("" + $async$self.iterations);
      ...
      updateStatus$0: function() {
        ...
        if (J.$add$ansx(J.get$length$asx(res.$index(0, "c")), J.get$length$asx(res.$index(0, "h"))) === 25)
...
;
  ...
  }, "_dartProxyCtor", "GAME_HTML_NODE", "$get$GAME_HTML_NODE", function() {
  ...
  $ = new Isolate();
  init.metadata = ["error", "stackTrace", null, "_", "element", "attributeName", "value", "context", "o", "index", "closure", "numberOfArguments", "arg1", "arg2", "arg3", "arg4", "arg", "time", "e", "name", "attr", "callback", "captureThis", "self", "arguments"];
  init.types = [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, args: [,]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: -1, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.Null, args: [P.String, P.String]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: P.Null, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: -1, args: [,]}, {func: 1, ret: P.Null, args: [, P.StackTrace]}, {func: 1, ret: P.Null, args: [P.int,,]}, {func: 1, ret: -1, opt: [P.Object]}, {func: 1, ret: P.Null, args: [,], opt: [,]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.Null, args: [P.Symbol0,,]}, {func: 1, ret: P.Null, args: [P.num]}, {func: 1, ret: -1, args: [W.Event]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, ret: P.bool, args: [[P.Set, P.String]]}, {func: 1, ret: P.JsFunction, args: [,]}, {func: 1, ret: [P.JsArray,,], args: [,]}, {func: 1, ret: P.JsObject, args: [,]}, {func: 1, ret: -1, args: [W.MouseEvent]}, {func: 1, ret: P.Object, args: [,]}];
