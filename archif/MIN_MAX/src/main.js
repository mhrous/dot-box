  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Border: {
      ...
      draw$0: function() {
        ...
        t1.width = "400px";
        for (str = "", i = 0; i <= 3; ++i)
          for (t1 = i * 133.33333333333334, j = 0; j <= 3; ++j)
            str += '        <div\n          class="dot"\n          style="\n              top:' + C.JSNumber_methods.toInt$0(t1) + "px;\n              left:" + C.JSNumber_methods.toInt$0(j * 133.33333333333334) + "px;\n              width:" + C.JSInt_methods.toInt$0(25) + "px ;\n              height:" + C.JSInt_methods.toInt$0(25) + 'px">\n        </div>\n         ';
        for (i = 0; i < 3; ++i)
          for (t1 = i * 3, t2 = i * 133.33333333333334 + 25, j = 0; j < 3; ++j)
            str += '        <div\n          class="box "\n          style="\n            top:' + C.JSNumber_methods.toInt$0(t2) + "px;\n            left:" + C.JSNumber_methods.toInt$0(j * 133.33333333333334 + 25) + "px;\n            width:" + C.JSDouble_methods.toInt$0(108.33333333333334) + "px ;\n            height:" + C.JSDouble_methods.toInt$0(108.33333333333334) + 'px ;"\n          data-id="' + (t1 + j) + '">\n        </div>\n        ';
        for (i = 0; i <= 3; ++i)
          for (t1 = i * 133.33333333333334 - 20, j = 0; j < 3; ++j)
    ...
    Game: {
      ...
      generateComputerDecision$0: function() {
        ...
        while (true) {
          if (!(res !== 0 && this.border.move.length !== 0))
            break;
          this.iterations = 0;
          ai_move = this.maximizePlay$2(this.border, 5);
      ...
      maximizePlay$2: function(newBorder, depth) {
        ...
        for (t1 = possibleMovements.length, t2 = depth - 1, _i = 0; _i < possibleMovements.length; possibleMovements.length === t1 || (0, H.throwConcurrentModificationError)(possibleMovements), ++_i) {
          ...
          if (res !== -1) {
            ++this.iterations;
            next_move = res > 0 ? this.maximizePlay$2(new_board, t2) : this.minimizePlay$2(new_board, t2);
      ...
      minimizePlay$2: function(newBorder, depth) {
        var score, possibleMovements, min, t1, t2, _i, t3, new_board, res, next_move;
        P.print("min1");
        score = newBorder.score$0();
        if (depth === 0 || newBorder.move.length === 0)
          return [null, score];
        ...
        for (t1 = possibleMovements.length, t2 = depth - 1, _i = 0; _i < possibleMovements.length; possibleMovements.length === t1 || (0, H.throwConcurrentModificationError)(possibleMovements), ++_i) {
          t3 = H.stringTypeCheck(possibleMovements[_i]);
          new_board = new Y.Border(P.List_List$from(newBorder.box, true, null), P.List_List$from(newBorder.move, true, null));
          res = new_board.place$2(t3, "h");
          if (res !== -1) {
            ++this.iterations;
            next_move = res > 0 ? this.minimizePlay$2(new_board, t2) : this.maximizePlay$2(new_board, t2);
            if (min[0] == null || J.$lt$n(next_move[1], min[1])) {
              C.JSArray_methods.$indexSet(min, 0, t3);
      ...
      updateStatus$0: function() {
        ...
        if (J.$add$ansx(J.get$length$asx(res.$index(0, "c")), J.get$length$asx(res.$index(0, "h"))) === 9) {
