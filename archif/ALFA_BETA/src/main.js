...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Primitives_functionNoSuchMethod_closure: {
      "^": "Closure:10;_box_0,namedArgumentList,$arguments",
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 4, 2, 14, 1, 2, 3],
      $isFuture: 1,
      static: {
    ...
    _Html5NodeValidator: {
      ...
      static: {
        ...
        _Html5NodeValidator__standardAttributeValidator: [function(element, attributeName, value, context) {
          ...
          return true;
        }, "call$4", "html__Html5NodeValidator__standardAttributeValidator$closure", 16, 0, 9, 4, 5, 6, 7],
        _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          H.interceptedTypeCheck(element, "$isElement");
          H.stringTypeCheck(attributeName);
          H.stringTypeCheck(value);
          return H.interceptedTypeCheck(context, "$is_Html5NodeValidator").uriPolicy.allowsUri$1(value);
        }, "call$4", "html__Html5NodeValidator__uriAttributeValidator$closure", 16, 0, 9, 4, 5, 6, 7]
      }
    },
    ImmutableListMixin: {
      "^": "Object;$ti",
    ...
    }, null, null, 16, 0, null, 20, 21, 22, 23],
    ...
    }, "call$1", "js___convertToDart$closure", 4, 0, 26, 8],
    ...
    Border: {
      ...
      draw$0: function() {
        ...
        t1.width = "400px";
        for (str = "", i = 0; i <= 4; ++i)
          for (t1 = i * 100, j = 0; j <= 4; ++j)
            str += '        <div\n          class="dot"\n          style="\n              top:' + C.JSInt_methods.toInt$0(t1) + "px;\n              left:" + C.JSInt_methods.toInt$0(j * 100) + "px;\n              width:" + C.JSInt_methods.toInt$0(25) + "px ;\n              height:" + C.JSInt_methods.toInt$0(25) + 'px">\n        </div>\n         ';
        for (i = 0; i < 4; ++i)
          for (t1 = i * 4, t2 = i * 100 + 25, j = 0; j < 4; ++j)
            str += '        <div\n          class="box "\n          style="\n            top:' + C.JSInt_methods.toInt$0(t2) + "px;\n            left:" + C.JSInt_methods.toInt$0(j * 100 + 25) + "px;\n            width:" + C.JSInt_methods.toInt$0(75) + "px ;\n            height:" + C.JSInt_methods.toInt$0(75) + 'px ;"\n          data-id="' + (t1 + j) + '">\n        </div>\n        ';
        for (i = 0; i <= 4; ++i)
          for (t1 = i * 100 - 20, j = 0; j < 4; ++j)
  ...
  }], ["", "class/const.dart",, K, {}], ["", "class/game.dart",, D, {
    "^": "",
    Game: {
      ...
      generateComputerDecision$0: function() {
        var res, ai_move, t1, t2, t3;
        res = 1;
        while (true) {
          if (!(res !== 0 && this.border.move.length !== 0))
            break;
          this.iterations = 0;
          ai_move = this.maximizePlay$4(this.border, 6, -999999, 999999);
          res = this.border.place$2(ai_move[0], "c");
      ...
      updateStatus$0: function() {
        ...
        if (J.$add$ansx(J.get$length$asx(res.$index(0, "c")), J.get$length$asx(res.$index(0, "h"))) === 16)
